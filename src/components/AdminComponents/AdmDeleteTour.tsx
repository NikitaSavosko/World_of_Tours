"use client"
import { deleteTour, GetAllTourPosts } from "@/actions/tour-post-action";
import {
...
const AdmDeleteTour = ({ tourId }: Props) => {
    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Вы точно хотите удалить тур?</AlertDialogTitle>
